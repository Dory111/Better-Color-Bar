...
<b><font size = "3">bar_box</font></b>: *boolean*, default *FALSE*.
...
as *labels_at*. <br/> <br/> <b><font size = "3">labels_side</font></b>:
*char*, default *‘right’*. Accepts *‘left’* or *‘right’*. Defines
whether in a vertical bar to draw labels to the left or right of the
bar. In a horizontal bar *‘right’* draws labels on the bottom and
*‘left’* draws labels on the top. <br/> <br/>
...
the final value). <br/> <br/> <b><font size = "3">horizontal</font></b>:
*boolean*, default *FALSE*. Defines whether to draw bar in a horizontal
orientation. Default argument of *FALSE* means bar is drawn vertically.
<br/>
